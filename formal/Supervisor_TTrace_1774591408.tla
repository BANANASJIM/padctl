---- MODULE Supervisor_TTrace_1774591408 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("Supervisor_TTrace_1774591408.json", _TETrace)
...
\*
\*trace == IODeserialize("Supervisor_TTrace_1774591408.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG Supervisor_TTrace_1774591408 ----
CONSTANTS
    Devices = { d1 , d2 }
    MaxReloads = 3
    d1 = d1
...
ALIAS
    _expression
=============================================================================
\* Generated on Thu Mar 26 23:03:28 PDT 2026